...
function startGulp(name, opts) {
  ...
  var buildPath = './node_modules/lifetioncore-build/';
  ...
  if (browser) {
    ...
    if (name !== 'lib') {
      browserifyCommand = browserifyPath + ' --require ./index.js:' + fullname + ' --external lifetioncore-lib -o ' + fullname + '.js';
    } else {
      browserifyCommand = browserifyPath + ' --require ./index.js:lifetioncore-lib -o lifetioncore-lib.js';
    }
